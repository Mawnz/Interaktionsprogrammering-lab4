...
// call the update method on each of the observers in the array
  ...
  this.getRecipes = function(model, type, filter, cb, cbError){
        ...
        //beforeSend: function() { $('#loading').show(), $('#dishRows').hide(); },
				...
				success: function(data){
					...
					for(var i in recipes){
						model.recipeInformation(recipes[i], function(recipe){
							...
							if(model.dishes.length == recipes.length)cb(model.dishes);
